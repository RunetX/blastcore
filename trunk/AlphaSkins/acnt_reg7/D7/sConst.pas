...
{$ENDIF} // UNICODE
  ...
  TacImgType = (itisaBorder, itisaTexture, itisaGlyph, itisaGlow, itisaPngGlyph);//, itisanOldType);
...
{$IFDEF RUNIDEONLY}
const
  sIsRUNIDEONLYMessage = 'This version of component is trial, for purchasing the fully functional version visit www.alphaskins.com please. Thanks!';
{$ENDIF}
